...
from .serilizer import UserSerilizer,User,RestPasswordSerilizer,SetNewPasswordSerializer,ForgetPasswordSerilizer,forgetPassword
...
class RequestPassword(generics.GenericAPIView):
    ...
    def post(self,request):
        ...
        if User.objects.filter(email=email).exists():
                ...
                redirect_url=('http://localhost:3000/update/${userId}/')
